...
const (
	...
	// RPC.
	HealthServiceHealthCheckProcedure = "/api.v1.HealthService/HealthCheck"
)
...
// HealthCheck calls api.v1.HealthService.HealthCheck.
func (c *healthServiceClient) HealthCheck(ctx context.Context, req *v1.HealthCheckRequest) (*v1.HealthCheckResponse, error) {
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	healthServiceMethods := v1.File_api_v1_health_proto.Services().ByName("HealthService").Methods()
	healthServiceHealthCheckHandler := connect.NewUnaryHandlerSimple(
...
func (UnimplementedHealthServiceHandler) HealthCheck(context.Context, *v1.HealthCheckRequest) (*v1.HealthCheckResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.HealthService.HealthCheck is not implemented"))
}
