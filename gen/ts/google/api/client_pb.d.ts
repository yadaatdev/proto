 ...
 */
export declare type BatchingConfigProto = Message<"google.api.BatchingConfigProto"> & {
  /**
 ...
 */
export declare type BatchingSettingsProto = Message<"google.api.BatchingSettingsProto"> & {
  /**
 ...
 */
export declare type BatchingDescriptorProto = Message<"google.api.BatchingDescriptorProto"> & {
  /**
